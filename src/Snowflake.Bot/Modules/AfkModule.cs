...
public sealed class AfkModule : SnowflakeModuleBase
{
    ...
    [SlashCommandGroup("mod", "AFK moderation and configuration commands")]
    [DescriptionLocalization(Localization.Spanish, "Comandos de moderación y configuración de AFK")]
    [DescriptionLocalization(Localization.Portuguese, "Comandos de moderação e configuração de AFK")]
    public sealed class AfkModSubModule : SnowflakeModuleBase
    {
        private readonly AfkService _afk;
        private readonly MessagesService _msg;

        public AfkModSubModule(AfkService afk, MessagesService msg)
        {
            _afk = afk;
            _msg = msg;
        }
